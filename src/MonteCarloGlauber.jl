...
export generate_bg, generate_tw_pt_fct_entropy, generate_bg_twpt_fct, change_norm, generate_bg_twpt_fct_save, generate_ncoll, generate_bg_ncoll, generate_bg_ncoll_save
